...
public class DisplayButtonOnScreen : MonoBehaviour
{
    ...
    public static DisplayButtonOnScreen Instance;

    private string currentControlScheme;
    private string lastShownAction;
    ...
    void Start()
    {
        ...
        Rebind.Instance.onKeyRebinded.AddListener(OnInputChanged);
    }
    ...
    {
        if (!string.IsNullOrEmpty(lastShownAction))
        {
            UpdateButtonPrompt(lastShownAction, myTextPrompt.text);
        }
    }
    ...
    {
        // print("displaying: " + actionName + " | " + text);
        lastShownAction = actionName;
        UpdateButtonPrompt(actionName, text);
        ShowingPrompt = true;
    }

    private void UpdateButtonPrompt(string actionName, string text = null)
    {
    ...
    {
        // print("Hide button prompt");
        _frames = null;
        myImage.sprite = null;
        lastShownAction = null;
