...
public class ShowRebindPrompt : MonoBehaviour
{
    ...
    public static ShowRebindPrompt Instance;
    ...
    [Button()]
    public void DoShowRebindPrompt()
    {
        _isShown = true;
        ShowButtonPrompt("Start", "rebind");
    }

    [Button()]
    public void HideRebindPrompt()
    {
        _isShown = false;
        HideButtonPrompt();
    }
